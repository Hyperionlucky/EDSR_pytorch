...
#WDSR-a train
#python main.py --model wdsr_a --scale 2 --save wdsr_a_x2 --block_feats 512 --n_feats 128 --res_scale 0.1 --[r,g,b]_mean --reset
#python main.py --data_train train --model EDSR --scale 2 --save dem_EDSR_x2 --ext img --n_colors 1 --res_scale 0.1 --pre_train ../experiment/dem_train_256_1/model/model_latest.pt --lr 1e-5
# MDSR baseline model
...
#python main.py --data_test yanchuan --scale 2 --pre_train download --test_only --save_results --n_colors 1
#python main.py --data_test validate --scale 2 --pre_train ../experiment/dem_EDSR_x2/model/model_best.pt --test_only --n_colors 1 --res_scale 0.1 --data_range 1-111 --save_results
# test with my own edsr×2
#python main.py --data_test Demo --scale 2 --pre_train ../models/EDSR_2.pt --test_only --save_results
...
# test my own MDSR
#python main.py --model MDSR --data_test Demo --scale 2+3+4 --pre_train ../models/model_best.pt --test_only --save_results
...
# nohup python -u src2/main.py >logs/EDSR.log 2>&1 &